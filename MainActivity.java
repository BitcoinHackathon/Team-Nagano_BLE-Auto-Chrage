package com.example.kenji.ble4;
...
public class MainActivity extends AppCompatActivity{
    ...
    private String MacAddress = "38:DE:AD:18:31:24";
    private String MY_UUID = "00001101-0000-1000-8000-00805F9B34FB"; //PubKey is better
    ...
    private void Send(){
        //文字列を送信する
        byte[] bytes = {};
        String str = "org.bitcoinj.core.ECKey$ECDSASignature@f3aba33a";
        bytes = str.getBytes();
        try {
            //ここで送信
